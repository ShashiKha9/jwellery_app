...
class FeaturedProductsBloc
  ...
  FeaturedProductsBloc({required this.featuredRepository})
      : super(FeaturedProductsInitial()) {
    on<FetchedFeaturedProducts>(_onFetchedProducts);
    on<AddWishList>(_onAddWishlist);
  }
  void _onFetchedProducts(FetchedFeaturedProducts event,
      Emitter<FeaturedProductsState> emit) async {
  ...
  void _onAddWishlist(
      AddWishList event, Emitter<FeaturedProductsState> emit) async {
    try {
