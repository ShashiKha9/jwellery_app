...
class CategoriesApiProvider {
  ...
  Future<List<Category>?> getCategoryTypesApi() async {
    try{
...
log(categories.toString(),name: 'categories Response Api');

final category = categories.map((json)=> Category.fromJson(json)).toList();

return category;
 
    } on SocketException catch(e){

    log(e.toString(),name: 'error Categories Response');
