...
import 'package:jwellery_app/app/repositories/wishlist_repossitory.dart';
            ...
            BlocBuilder<WishListBloc, WishListState>(
              builder: (context, state) {
                ...
                return GridView.builder(
                                  ...
                                  ClipRRect(
                                    ...
                                    child: Stack(
                                     ...
                                     CachedNetworkImage(
                                      ...
                                      fit: BoxFit.cover,),
                                      imageUrl:  state.wishlistProducts[index].imageUrl,
                                         ...
                                         Positioned(
                                          ...
                                          child: GestureDetector(
                                            ...
                                            BlocProvider.of<FeaturedProductsBloc>(context).add(
                                                AddWishList(categoryId: state.wishlistProducts[index].id));
                                                setState(() {
                                           ...
                                           child: Icon(state.wishlistProducts[index].isFavorite? 
                                           Icons.favorite_outlined:
                                           Icons.favorite_outline_sharp,size: 30,
                                            color:state.wishlistProducts[index].isFavorite?
                  ...
                  return const Center(child: Text("No WishList Products"),);
                }
