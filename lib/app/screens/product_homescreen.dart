...
class _ProductHomescreenState extends State<ProductHomescreen> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(title:  Text("Jewellery",style: blueBold.copyWith(color: AppColors.brown),),
      elevation: 3,
          ...
          children: [
           ...
           height: 20,
            ...
            Padding(
              ...
              style: boldLightBrownMedium.copyWith(color: Colors.black,fontWeight: FontWeight.w500))),
